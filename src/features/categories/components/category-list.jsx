        ...
        <div className="col-12">
          <div className="card">
            ...
            <table className="table table-striped">
              <thead>
                <tr>
                  <th style={{direction: "rtl"}}>{t('categories.name')}</th>
                  <th style={{direction: "rtl"}}>{t('categories.operation')}</th>
                </tr>
              </thead>
              <tbody style={{direction: "rtl"}}>
                {
                  data.map((category) => {
                    return (
                      <tr key={category.id}>
                        <td style={{direction: "rtl"}}>{category.name}</td>
                        <td className="table-action" style={{direction: "rtl"}}>
